...
<!-- Minimal & Clean Project Cards Grid -->
<div class="project-grid">

  <!-- Project 1: Scalp Microbiome Meta-Analysis (Normal Reference) -->
  ...
  <!-- Project 2: Scalp Bacteriome across 3 Scalp Disorders (AA, AGA, SD) -->
  ...
  <!-- Project 3: Hallux Valgus and Onychocryptosis (Nationwide Matched Cohort) -->
  ...
  <!-- Project 5: Big Data & Epidemiology -->
